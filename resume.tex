...
\item{Play a key role in the execution of the client's product  : from concept, to managing a distributed team and software around it and then delivering the product to the market.}
\item{Lead distributed teams using Agile. Manage Scrum meetings and sprint goals.}
\item{Technologies used include AWS, Google Cloud Platform, Makefiles, Kubernetes, Docker, Golang and Postgres.}
